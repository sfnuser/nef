...
func (o *EthFlowDescription) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &varEthFlowDescription); err == nil {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "destMacAddr")
		delete(additionalProperties, "ethType")
		delete(additionalProperties, "fDesc")
		delete(additionalProperties, "fDir")
		delete(additionalProperties, "sourceMacAddr")
		delete(additionalProperties, "vlanTags")
		delete(additionalProperties, "srcMacAddrEnd")
		delete(additionalProperties, "destMacAddrEnd")
