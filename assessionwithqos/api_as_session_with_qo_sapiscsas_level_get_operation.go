...
func (r ApiScsAsIdSubscriptionsGetRequest) Execute() ([]AsSessionWithQoSSubscription, *_nethttp.Response, error) {
	return r.ApiService.ScsAsIdSubscriptionsGetExecute(r)
}
...
ScsAsIdSubscriptionsGet read all of the active subscriptions for the SCS/AS
 ...
 @return ApiScsAsIdSubscriptionsGetRequest
*/
func (a *AsSessionWithQoSAPISCSASLevelGETOperationApiService) ScsAsIdSubscriptionsGet(ctx _context.Context, scsAsId string) ApiScsAsIdSubscriptionsGetRequest {
	return ApiScsAsIdSubscriptionsGetRequest{
		ApiService: a,
		ctx: ctx,
		scsAsId: scsAsId,
...
//  @return []AsSessionWithQoSSubscription
func (a *AsSessionWithQoSAPISCSASLevelGETOperationApiService) ScsAsIdSubscriptionsGetExecute(r ApiScsAsIdSubscriptionsGetRequest) ([]AsSessionWithQoSSubscription, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AsSessionWithQoSAPISCSASLevelGETOperationApiService.ScsAsIdSubscriptionsGet")
	if err != nil {
