...
type _QosMonitoringInformationRm QosMonitoringInformationRm
...
func (o *QosMonitoringInformationRm) GetReqQosMonParams() []RequestedQosMonitoringParameter {
	if o == nil || o.ReqQosMonParams == nil {
...
func (o *QosMonitoringInformationRm) GetRepThreshDl() int32 {
	if o == nil || o.RepThreshDl.Get() == nil {
		var ret int32
		return ret
	}
...
func (o *QosMonitoringInformationRm) GetRepThreshUl() int32 {
	if o == nil || o.RepThreshUl.Get() == nil {
		var ret int32
		return ret
	}
...
func (o *QosMonitoringInformationRm) GetRepThreshRp() int32 {
	if o == nil || o.RepThreshRp.Get() == nil {
		var ret int32
		return ret
	}
...
func (o *QosMonitoringInformationRm) UnmarshalJSON(bytes []byte) (err error) {
	varQosMonitoringInformationRm := _QosMonitoringInformationRm{}

	if err = json.Unmarshal(bytes, &varQosMonitoringInformationRm); err == nil {
		*o = QosMonitoringInformationRm(varQosMonitoringInformationRm)
	}
