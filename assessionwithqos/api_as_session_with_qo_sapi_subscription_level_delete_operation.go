...
func (r ApiScsAsIdSubscriptionsSubscriptionIdDeleteRequest) Execute() (UserPlaneNotificationData, *_nethttp.Response, error) {
	return r.ApiService.ScsAsIdSubscriptionsSubscriptionIdDeleteExecute(r)
}
...
ScsAsIdSubscriptionsSubscriptionIdDelete Deletes an already existing subscription
 ...
 @return ApiScsAsIdSubscriptionsSubscriptionIdDeleteRequest
*/
func (a *AsSessionWithQoSAPISubscriptionLevelDELETEOperationApiService) ScsAsIdSubscriptionsSubscriptionIdDelete(ctx _context.Context, scsAsId string, subscriptionId string) ApiScsAsIdSubscriptionsSubscriptionIdDeleteRequest {
	return ApiScsAsIdSubscriptionsSubscriptionIdDeleteRequest{
		ApiService: a,
		ctx: ctx,
		scsAsId: scsAsId,
...
//  @return UserPlaneNotificationData
func (a *AsSessionWithQoSAPISubscriptionLevelDELETEOperationApiService) ScsAsIdSubscriptionsSubscriptionIdDeleteExecute(r ApiScsAsIdSubscriptionsSubscriptionIdDeleteRequest) (UserPlaneNotificationData, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AsSessionWithQoSAPISubscriptionLevelDELETEOperationApiService.ScsAsIdSubscriptionsSubscriptionIdDelete")
	if err != nil {
