...
type _UsageThresholdRm UsageThresholdRm
...
func (o *UsageThresholdRm) GetTotalVolume() int64 {
	if o == nil || o.TotalVolume.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *UsageThresholdRm) GetDownlinkVolume() int64 {
	if o == nil || o.DownlinkVolume.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *UsageThresholdRm) GetUplinkVolume() int64 {
	if o == nil || o.UplinkVolume.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *UsageThresholdRm) UnmarshalJSON(bytes []byte) (err error) {
	varUsageThresholdRm := _UsageThresholdRm{}

	if err = json.Unmarshal(bytes, &varUsageThresholdRm); err == nil {
		*o = UsageThresholdRm(varUsageThresholdRm)
	}
