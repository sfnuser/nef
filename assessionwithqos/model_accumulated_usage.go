...
type _AccumulatedUsage AccumulatedUsage
...
func (o *AccumulatedUsage) UnmarshalJSON(bytes []byte) (err error) {
	varAccumulatedUsage := _AccumulatedUsage{}

	if err = json.Unmarshal(bytes, &varAccumulatedUsage); err == nil {
		*o = AccumulatedUsage(varAccumulatedUsage)
	}
